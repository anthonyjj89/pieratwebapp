...
const { Organization, OrganizationMember, OrganizationInvite, JoinRequest } = require('../dist/models/organization');
...
async function setupDatabase() {
    ...
    try {
        ...
        await OrganizationMember.collection.createIndex(
        ...
        await JoinRequest.collection.createIndex(
